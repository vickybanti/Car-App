...
import {  Combobox, ComboboxButton,ComboboxOptions, ComboboxOption, Transition, MenuItem, ComboboxInput } from '@headlessui/react'
...
const SearchManufacturer = ({selected, setSelected} : SearchManufacturerProps) => {
  ...
  //s means empty space and g means global to be replaced with empty string
    return (
                    ...
                    >
                        ...
                        query !== "" ? (
                            ...
                            filteredManufacturers.map((item) => (
                                ...
                                >
                                    {({ focus, selected }) => (
              <div className={clsx('group flex gap-2', focus && 'bg-primary-blue')}>
