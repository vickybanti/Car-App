        ...
        <Transition appear show={isOpen} as={Fragment}>
            ...
            onClose={closeModal}>
                ...
                <div className='fixed inset-0 overflow-y-auto'>
                    <div className='flex mon-h-full items-center justify-center p-4 text-center'>
                    <TransitionChild
                    as={Fragment} 
                    enter="ease-out duration-300"
                ...
                >
                    ...
                    rounded-2xl transition-all flex flex-col gap-5 bg-white text-left shadow-xl p-6">
                        <button
                            type="button"
                            onClick={closeModal}
